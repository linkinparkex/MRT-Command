	...
	public partial class App : Application {
		...
		private void Application_Startup(object sender, StartupEventArgs e) {
			...
			if (!mutex!.WaitOne(TimeSpan.Zero, true)) {
				...
				if (e.Args.Contains("-des")) {
					//[*]
					Logger.Info("DESTROY消息");
					_ = NativeMethods.BroadcastMessage(NativeMethods.MAGPIE_WM_DESTROY);
				...
				//[*]
				if (e.Args.Contains("-cn")) {
					Logger.Info("CREATE全局消息");
					_ = NativeMethods.BroadcastMessage(NativeMethods.MAGPIE_WM_CREATE_NEW);
