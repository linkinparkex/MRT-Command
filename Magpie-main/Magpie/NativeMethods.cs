...
namespace Magpie {
	...
	internal class NativeMethods {
		...
		public static readonly int MAGPIE_WM_CREATE_NEW = RegisterWindowMessage("MAGPIE_WM_CREATE_NEW");
		public static readonly int MAGPIE_WM_DESTROY = RegisterWindowMessage("MAGPIE_WM_DESTROY");
